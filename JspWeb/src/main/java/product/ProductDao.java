...
public class ProductDao {
	...
	public List<IndexDto> finDatabaseUtilyKeyword(String keyword) {
		Connection conn = DatabaseUtil.getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public List<IndexDto> finDatabaseUtilyCompNo(int compNo) {
		Connection conn = DatabaseUtil.getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sb = new StringBuffer(); 
	...
	public DetailProdRespDto finDatabaseUtilyId(int prodNo) {
		Connection conn = DatabaseUtil.getConnection();
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		StringBuffer sb = new StringBuffer();
